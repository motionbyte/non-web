...
export default function NotFound() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6 sm:py-16">
      ...
      <h1 className="mt-4 font-display text-4xl sm:text-6xl">Not on this desk.</h1>
      <p className="mt-4 text-lg text-black/65">That page is not in the encyclopedia. Search the record, or file the name.</p>
